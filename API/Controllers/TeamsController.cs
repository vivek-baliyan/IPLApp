...
namespace API.Controllers
{
    public class TeamsController : BaseApiController
    {
        ...
        {
            var teams = await _unitOfWork.Teams.GetAllAsync(includeroperties: "Logo");
            return _mapper.Map<IEnumerable<TeamDto>>(teams);
        }
        [HttpGet("{id}", Name = "GetTeam")]
        public async Task<TeamDto> GetTeamAsync(int id)
        {
            var team = await _unitOfWork.Teams.GetFirstOrDefaultAsync(x => x.Id == id, includeroperties: "Logo");
        ...
        {
            var team = await _unitOfWork.Teams.GetFirstOrDefaultAsync(x => x.Id == teamUpdateDto.Id);
        ...
        {
            var team = await _unitOfWork.Teams.GetFirstOrDefaultAsync(x => x.Id == id);
